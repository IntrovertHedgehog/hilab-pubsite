const research_data = [
  {
    ...
    content: `Lifestyle change is key to managing chronic diseases such as diabetes, hypertension and hyperlipidaemia. However, constraints on resources and time within Singapore's healthcare systems often lead to suboptimal support for patients in their efforts to improve lifestyle habits.  
To address this, we partner with the Singapore General Hospital (SGH) and Duke-NUS Medical School to develop EMPOWER—a mobile app-based platform for the efficient and effective management of chronic diseases. By using a dedicated mobile app, patients can log a comprehensive range of activities and receive intelligent nudges based on these logs. They can also review their logs as reports, play games, or share them with healthcare workers. Users benefit from personalized healthcare services, while healthcare professionals can utilise technology to streamline and enhance care delivery. 
